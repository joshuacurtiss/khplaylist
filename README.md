...
Latest stable release available here: 
  ...
  * Mac: [KH-Playlist-1.3.4.dmg](https://github.com/joshuacurtiss/khplaylist/releases/download/1.3.4/KH-Playlist-1.3.4.dmg)
  * Windows:
    * Installer: [KH-Playlist-Setup-1.3.4.exe](https://github.com/joshuacurtiss/khplaylist/releases/download/1.3.4/KH-Playlist-Setup-1.3.4.exe)
    * Portable version (no installation required): [KH-Playlist-1.3.4.exe](https://github.com/joshuacurtiss/khplaylist/releases/download/1.3.4/KH-Playlist-1.3.4.exe)
